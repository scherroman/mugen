...
def test_largest_width_and_height_for_dimensions(dimensions_list, default, expected_dimensions):
    assert v_sizing.largest_width_and_height_for_dimensions(dimensions_list, default) == expected_dimensions
