...
def test_start_end_locations_from_locations(locations, expected_start_locations, expected_end_locations):
    assert location.start_end_locations_from_locations(locations) == (expected_start_locations, expected_end_locations)
...
def test_start_end_locations_from_intervals(intervals, expected_start_locations, expected_end_locations):
    assert location.start_end_locations_from_intervals(intervals) == (expected_start_locations, expected_end_locations)
