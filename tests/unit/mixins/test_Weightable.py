...
def test_normalized_weights(weights, expected):
    assert Weightable.normalized_weights(weights) == expected
...
def test_weight_percentages(weights, expected):
    assert Weightable.weight_percentages(weights) == expected
