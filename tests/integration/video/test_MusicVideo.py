...
from tests.integration.video.segments.test_VideoSegment import wolf_segment
...
@pytest.fixture
def basic_music_video(wolf_segment, tatami_segment, orange_segment) -> MusicVideo:
    return MusicVideo([wolf_segment, tatami_segment, orange_segment])
