...
from tests import MUSIC_VIDEO_PATH, TRACKING_SHOT_VIDEO_PATH
...
def test_video_segment__parses_streams():
    ...
    assert music_video_segment.video_stream is not None
    assert music_video_segment.audio_stream is not None
