...
def preview_audio(args):
    ...
    # Prepare Inputs
    output_extension = (
        ".wav" if preview_mode == PreviewMode.AUDIO else VideoWriter.VIDEO_EXTENSION
    )
    ...
    message(f"Creating audio preview '{Path(output_path).stem}'...")
...
def prepare_args(args):
    ...
    """
    if (
        getattr_none(args, "duration") is not None
        and getattr_none(args, "event_locations") is None
    ):
...
def parse_args(args):
    ...
    video_parser.add_argument(
        ...
        "--video-preset",
        dest="video_preset",
        default=VideoWriter.VIDEO_PRESET,
    ...
    video_parser.add_argument(
        ...
        "--video-codec",
        dest="video_codec",
        default=VideoWriter.VIDEO_CODEC,
    ...
    audio_parser.add_argument(
        ...
        "--audio-codec",
        dest="audio_codec",
        default=VideoWriter.AUDIO_CODEC,
    ...
    create_parser = subparsers.add_parser(
        "create",
        parents=[audio_parser, video_parser, event_parser],
    ...
    preview_parser = subparsers.add_parser(
        "preview",
        parents=[audio_parser, event_parser],
        formatter_class=argparse.ArgumentDefaultsHelpFormatter,
    ...
    preview_parser.add_argument(
        ...
        "--preview-mode",
        dest="preview_mode",
        default=PreviewMode.AUDIOVISUAL,
        help=f"The method of previewing events. Supported values are {[e.value for e in PreviewMode]}",
    )
